...
CREATE TABLE `promo` (
  ...
  `deskripsiPromo` varchar(255) DEFAULT NULL,
...
ALTER TABLE `transaction`
  ...
  ADD KEY `IDpromo_promo_transaction` (`IDpromo`);
...
ALTER TABLE `transaction`
  ...
  ADD CONSTRAINT `IDpromo_promo_transaction` FOREIGN KEY (`IDpromo`) REFERENCES `promo` (`IDpromo`),
